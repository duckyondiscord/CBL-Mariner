...
Name:           php-sebastian-environment5
Version:        5.1.4
Release:        2%{?dist}
Summary:        Handle HHVM/PHP environments, version 5

License:        BSD
URL:            https://github.com/sebastianbergmann/environment
Source0:        https://github.com/sebastianbergmann/environment/archive/refs/tags/%{version}.tar.gz#/%{name}-%{version}.tar.gz
...
cp -pr src %{buildroot}%{php_home}/SebastianBergmann/Environment5
...
for cmd in php php74 php80 php81; do
  if which $cmd; then
   $cmd -d auto_prepend_file=%{buildroot}%{php_home}/SebastianBergmann/Environment5/autoload.php \
     -d pcov.enabled=1 \
...
%dir %{php_home}/SebastianBergmann
     %{php_home}/SebastianBergmann/Environment5
